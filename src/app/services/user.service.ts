...
export class UserService {
    ...
    getAllUsers() {
        ...
        const url = 'http://10.10.1.191:3000/api/user';
    ...
    deleteUser(userId) {
        ...
        headers.append('Authorization', this.auth.token);
        headers.append('Content-Type', 'application/json');
        const url = 'http://10.10.1.191:3000/api/user/deleteUser/' + userId;
        return this.http.get(url, { headers: headers}).pipe(map(res => res.json()));
    }
    ...
    changePassword(userPasswordDetails) {
        ...
        headers.append('Authorization', this.auth.token);
        headers.append('Content-Type', 'application/json');
        const url = 'http://10.10.1.191:3000/api/user/changePassword';
    ...
    restPassword(userRestPasswordDetails) {
        ...
        headers.append('Authorization', this.auth.token);
        headers.append('Content-Type', 'application/json');
        const url = 'http://10.10.1.191:3000/api/user/restPassword';
    ...
    getUserLogs(userId) {
        ...
        headers.append('Authorization', this.auth.token);
        headers.append('Content-Type', 'application/json');
        const url = 'http://10.10.1.191:3000/api/getUserLogs/' + userId;
        return this.http.get(url, { headers: headers}).pipe(map(res => res.json()));
    }
    ...
    editUser(userDetails: any) {
        ...
        headers.append('Authorization', this.auth.token);
        headers.append('Content-Type', 'application/json');
        const url = 'http://10.10.1.191:3000/api/user/editUser';
